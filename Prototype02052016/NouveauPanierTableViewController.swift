//
//  NouveauPanierTableViewController.swift
//  Prototype02052016
//
...
class NouveauPanierTableViewController: UITableViewController {
    ...
    func chargerPaniers() {
        ...
        //Echantillons
        let echantillon1 = NouvelEchantillon(nomEchantillon: "Lexomil", referenceEchantillon: "010255555", quantiteEchantillon: 50)
        let echantillon2 = NouvelEchantillon(nomEchantillon: "Doliprane", referenceEchantillon: "010256655", quantiteEchantillon: 10)
        
        let echantillon3 = NouvelEchantillon(nomEchantillon: "Dafalgan", referenceEchantillon: "010256655", quantiteEchantillon: 60)
        let echantillon4 = NouvelEchantillon(nomEchantillon: "Medoc1", referenceEchantillon: "010256655", quantiteEchantillon: 5)
        let echantillon5 = NouvelEchantillon(nomEchantillon: "Propofol", referenceEchantillon: "010256655", quantiteEchantillon: 80)
        let echantillon6 = NouvelEchantillon(nomEchantillon: "AutreMedoc", referenceEchantillon: "010256655", quantiteEchantillon: 20)
        let echantillon7 = NouvelEchantillon(nomEchantillon: "Des Pommes", referenceEchantillon: "010256655", quantiteEchantillon: 15)
        let echantillon8 = NouvelEchantillon(nomEchantillon: "MedocTruc", referenceEchantillon: "010256655", quantiteEchantillon: 100)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! NouveauPanierTableViewCell
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "ShowDetail" {
            ...
            let panierDetailViewController = nav.topViewController as! NouveauPanierViewController
            if let selectedPanierCell = sender as? NouveauPanierTableViewCell{
            ...
            let nav = segue.destinationViewController as! UINavigationController
            let panierAjoutViewController = nav.topViewController as! NouveauAjouterPanierViewController
            print(segue.identifier)
