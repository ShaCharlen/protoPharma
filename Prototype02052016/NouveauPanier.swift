...
class Panier: NSObject, NSCoding {
    ...
    //MARK: initialization
    init?(nom : String, medecin : String? , etat : Etat, contenu : [NouvelEchantillon]?){
    ...
    required convenience init?(coder aDecoder: NSCoder){
        ...
        let contenu = aDecoder.decodeObjectForKey(PropertyKey.tabEchantillonsKey) as? [NouvelEchantillon]
